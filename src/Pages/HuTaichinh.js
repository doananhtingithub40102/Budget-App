...
import { TongCongTaiChinh, TongChiTieuTheoHu } from "../Utils/CalculatorTongCong"
...
const Hangngay = () => {
    ...
    const [soDuCacHu, setSoDuCacHu] = useState({
        "Thiết yếu": { tongThu: 0, tongChi: 0 },
        "Hưởng thụ": { tongThu: 0, tongChi: 0 },
        "Giáo dục": { tongThu: 0, tongChi: 0 },
        "Tiết kiệm dài hạn": { tongThu: 0, tongChi: 0 },
        "Tự do tài chính": { tongThu: 0, tongChi: 0 },
        "Từ thiện": { tongThu: 0, tongChi: 0 }
    })
    ...
    useEffect(() => {
        ...
        setSoDuCacHu({
            "Thiết yếu": { tongThu: TongCongTaiChinh(cacGiaoDich)[0] * 0.55, tongChi: TongChiTieuTheoHu(cacGiaoDich, "Thiết yếu") },
            "Hưởng thụ": { tongThu: TongCongTaiChinh(cacGiaoDich)[0] * 0.1, tongChi: TongChiTieuTheoHu(cacGiaoDich, "Hưởng thụ") },
            "Giáo dục": { tongThu: TongCongTaiChinh(cacGiaoDich)[0] * 0.1, tongChi: TongChiTieuTheoHu(cacGiaoDich, "Giáo dục") },
            "Tiết kiệm dài hạn": { tongThu: TongCongTaiChinh(cacGiaoDich)[0] * 0.1, tongChi: TongChiTieuTheoHu(cacGiaoDich, "Tiết kiệm dài hạn") },
            "Tự do tài chính": { tongThu: TongCongTaiChinh(cacGiaoDich)[0] * 0.1, tongChi: TongChiTieuTheoHu(cacGiaoDich, "Tự do tài chính") },
            "Từ thiện": { tongThu: TongCongTaiChinh(cacGiaoDich)[0] * 0.05, tongChi: TongChiTieuTheoHu(cacGiaoDich, "Từ thiện") }
        })
    }, [cacGiaoDich])
                    ...
                    <div className="soDuCacHu mx-3 p-2">
                        <Row className="px-3 py-1 my-2 align-items-center huHover" onClick={() => scrollToSpecificElementById("#lichSuGD")}>
                            ...
                            <div className="soDuHu col-4 text-end">
                                {FormatSoTien(Math.floor(soDuCacHu["Thiết yếu"].tongThu) - soDuCacHu["Thiết yếu"].tongChi)}
                            </div>
                        </Row>
                        <Row className="px-3 py-1 my-2 align-items-center huHover" onClick={() => scrollToSpecificElementById("#lichSuGD")}>
                            ...
                            <div className="soDuHu col-4 text-end">
                                {FormatSoTien(Math.floor(soDuCacHu["Hưởng thụ"].tongThu) - soDuCacHu["Hưởng thụ"].tongChi)}
                            </div>
                        </Row>
                        <Row className="px-3 py-1 my-2 align-items-center huHover" onClick={() => scrollToSpecificElementById("#lichSuGD")}>
                            ...
                            <div className="soDuHu col-4 text-end">
                                {FormatSoTien(Math.floor(soDuCacHu["Giáo dục"].tongThu) - soDuCacHu["Giáo dục"].tongChi)}
                            </div>
                        </Row>
                        <Row className="px-3 py-1 my-2 align-items-center huHover" onClick={() => scrollToSpecificElementById("#lichSuGD")}>
                            ...
                            <div className="soDuHu col-4 text-end">
                                {FormatSoTien(Math.floor(soDuCacHu["Tiết kiệm dài hạn"].tongThu) - soDuCacHu["Tiết kiệm dài hạn"].tongChi)}
                            </div>
                        </Row>
                        <Row className="px-3 py-1 my-2 align-items-center huHover" onClick={() => scrollToSpecificElementById("#lichSuGD")}>
                            ...
                            <div className="soDuHu col-4 text-end">
                                {FormatSoTien(Math.floor(soDuCacHu["Tự do tài chính"].tongThu) - soDuCacHu["Tự do tài chính"].tongChi)}
                            </div>
                        </Row>
                        <Row className="px-3 py-1 my-2 align-items-center huHover" onClick={() => scrollToSpecificElementById("#lichSuGD")}>
                            ...
                            <div className="soDuHu col-4 text-end">
                                {FormatSoTien(Math.floor(soDuCacHu["Từ thiện"].tongThu) - soDuCacHu["Từ thiện"].tongChi)}
                            </div>
                        </Row>
                    </div>
                </div>
